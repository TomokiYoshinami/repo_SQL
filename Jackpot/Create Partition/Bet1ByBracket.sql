...
ALTER TABLE [dbo].[Bet1ByBracket] DROP CONSTRAINT [PK_Bet1ByBracket]


ALTER TABLE [dbo].[Bet1ByBracket] ADD  CONSTRAINT [PK_Bet1ByBracket] PRIMARY KEY NONCLUSTERED 
(
	[RaceID] DESC,
	[Kumi1] ASC,
	[Kumi2] ASC,
...
CREATE CLUSTERED INDEX [ClusteredIndex_on_PS_Date_636027079302472798] ON [dbo].[Bet1ByBracket]
(
	[RaceDate]
)WITH (SORT_IN_TEMPDB = ON, DROP_EXISTING = OFF, ONLINE = OFF) ON [PS_Date]([RaceDate])


DROP INDEX [ClusteredIndex_on_PS_Date_636027079302472798] ON [dbo].[Bet1ByBracket]
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_Bet1ByBracket] ON [dbo].[Bet1ByBracket]
(
	[RaceDate] DESC,
	[JyoCD] ASC,
	[Kaiji] ASC,
