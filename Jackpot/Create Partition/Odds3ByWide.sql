...
ALTER TABLE [dbo].[Odds3ByWide] DROP CONSTRAINT [PK_Odds3ByWide]


ALTER TABLE [dbo].[Odds3ByWide] ADD  CONSTRAINT [PK_Odds3ByWide] PRIMARY KEY NONCLUSTERED 
(
	[RaceID] DESC,
	[BetTypeCD] ASC,
	[Kumi1] ASC,
...
CREATE CLUSTERED INDEX [ClusteredIndex_on_PS_Date_636027175809477247] ON [dbo].[Odds3ByWide]
(
	[RaceDate]
)WITH (SORT_IN_TEMPDB = ON, DROP_EXISTING = OFF, ONLINE = OFF) ON [PS_Date]([RaceDate])


DROP INDEX [ClusteredIndex_on_PS_Date_636027175809477247] ON [dbo].[Odds3ByWide]
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_Odds3ByWide] ON [dbo].[Odds3ByWide]
(
	[RaceDate] DESC,
	[JyoCD] ASC,
	[Kaiji] ASC,
