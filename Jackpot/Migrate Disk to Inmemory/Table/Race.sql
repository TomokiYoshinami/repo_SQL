...
(
	...
	[YoubiCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[TokuNum] [nchar](4) COLLATE Japanese_CI_AS NULL,
	...
	[Kubun] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[Nkai] [int] NULL,
	[GradeCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[GradeCDBefore] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[SyubetuCD] [nchar](2) COLLATE Japanese_CI_AS NULL,
	[KigoCD] [nchar](3) COLLATE Japanese_CI_AS NULL,
	[JyuryoCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[JyokenCD1] [nchar](3) COLLATE Japanese_CI_AS NULL,
	[JyokenCD2] [nchar](3) COLLATE Japanese_CI_AS NULL,
	[JyokenCD3] [nchar](3) COLLATE Japanese_CI_AS NULL,
	[JyokenCD4] [nchar](3) COLLATE Japanese_CI_AS NULL,
	[JyokenCD5] [nchar](3) COLLATE Japanese_CI_AS NULL,
	[JyokenName] [nvarchar](60) COLLATE Japanese_CI_AS NULL,
	[Kyori] [int] NULL,
	[KyoriBefore] [int] NULL,
	[DistanceTypeCD] [int] NULL,
	[DistanceType2CD] [int] NULL,
	[TrackCD] [nchar](2) COLLATE Japanese_CI_AS NULL,
	[TrackCDBefore] [nchar](2) COLLATE Japanese_CI_AS NULL,
	[CourseKubunCD] [nchar](2) COLLATE Japanese_CI_AS NULL,
	[CourseKubunCDBefore] [nchar](2) COLLATE Japanese_CI_AS NULL,
	...
	[TenkoCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[TrackTypeCD] [int] NULL,
	[TrackType2CD] [int] NULL,
	[TrackType3CD] [int] NULL,
	[CourseTypeCD] [int] NULL,
	[TrackConditionCD] [int] NULL,
	[SibaBabaCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[DirtBabaCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	...
	[TS] [datetime2](7) NULL,
	[IsNormal] [bit] NULL,
	[SmileCD] [nchar](1) COLLATE Japanese_CI_AS NULL,
	[TimeCount] [int] NULL,
...
INDEX [IX_Race] UNIQUE NONCLUSTERED HASH 
(
	[RaceDate],
	[JyoCD],
	[Kaiji],
...
INDEX [IX_Race_IsNormal] NONCLUSTERED HASH 
(
	[IsNormal]
)WITH ( BUCKET_COUNT = 2),
INDEX [IX_Race_JyokenCD5] NONCLUSTERED HASH 
(
	[JyokenCD5]
)WITH ( BUCKET_COUNT = 32),
INDEX [IX_Race_RaeDate] NONCLUSTERED HASH 
(
	[RaceDate]
)WITH ( BUCKET_COUNT = 16384),
INDEX [IX_Race_SmileCD] NONCLUSTERED HASH 
(
	[SmileCD]
)WITH ( BUCKET_COUNT = 8),
INDEX [IX_Race_TrackCD] NONCLUSTERED HASH 
(
	[TrackCD]
)WITH ( BUCKET_COUNT = 32),
INDEX [IX_Race_TrackTypeCD] NONCLUSTERED HASH 
(
	[TrackTypeCD]
)WITH ( BUCKET_COUNT = 4),
