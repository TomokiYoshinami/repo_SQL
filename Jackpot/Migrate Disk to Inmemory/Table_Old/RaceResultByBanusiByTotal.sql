...
EXEC dbo.sp_rename @objname = N'[dbo].[RaceResultByBanusiByTotal]', @newname = N'RaceResultByBanusiByTotal_old', @objtype = N'OBJECT'
GO

USE [Jackpot]
GO

EXEC [Jackpot].dbo.sp_rename @objname = N'[dbo].[DF_RaceResultByBanusiByTotal_GUID]', @newname = N'DF_RaceResultByBanusiByTotal_GUIDOnRaceResultByBanusiByTotal_old', @objtype = N'OBJECT'
GO
...
CREATE TABLE [dbo].[RaceResultByBanusiByTotal]
(
 ...
 CONSTRAINT [RaceResultByBanusiByTotal_éÂÉLÅ[]  PRIMARY KEY NONCLUSTERED HASH 
(
	[RaceID],
	[KettoNum],
	[SummaryType]
