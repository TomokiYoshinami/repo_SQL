...
EXEC dbo.sp_rename @objname = N'[dbo].[RaceResultByBreederByTotal]', @newname = N'RaceResultByBreederByTotal_old', @objtype = N'OBJECT'
GO

USE [Jackpot]
GO

EXEC [Jackpot].dbo.sp_rename @objname = N'[dbo].[DF_RaceResultByBreederByTotal_GUID]', @newname = N'DF_RaceResultByBreederByTotal_GUIDOnRaceResultByBreederByTotal_old', @objtype = N'OBJECT'
GO
...
CREATE TABLE [dbo].[RaceResultByBreederByTotal]
(
 ...
 CONSTRAINT [RaceResultByBreederByTotal_éÂÉLÅ[]  PRIMARY KEY NONCLUSTERED HASH 
(
	[RaceID],
	[KettoNum],
	[SummaryType]
