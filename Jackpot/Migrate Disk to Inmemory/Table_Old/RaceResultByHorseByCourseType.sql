...
EXEC dbo.sp_rename @objname = N'[dbo].[RaceResultByHorseByCourseType]', @newname = N'RaceResultByHorseByCourseType_old', @objtype = N'OBJECT'
GO

USE [Jackpot]
GO

EXEC [Jackpot].dbo.sp_rename @objname = N'[dbo].[DF_RaceResultByHorseByCourseType_GUID]', @newname = N'DF_RaceResultByHorseByCourseType_GUIDOnRaceResultByHorseByCourseType_old', @objtype = N'OBJECT'
GO
...
CREATE TABLE [dbo].[RaceResultByHorseByCourseType]
(
 ...
 CONSTRAINT [RaceResultByHorseByCourseType_éÂÉLÅ[]  PRIMARY KEY NONCLUSTERED HASH 
(
	[RaceID],
	[KettoNum],
	[TrackTypeCD],
