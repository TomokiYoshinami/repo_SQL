...
EXEC dbo.sp_rename @objname = N'[dbo].[RaceResultByHorseByJyo]', @newname = N'RaceResultByHorseByJyo_old', @objtype = N'OBJECT'
GO

USE [Jackpot]
GO

EXEC [Jackpot].dbo.sp_rename @objname = N'[dbo].[DF_RaceResultByHorseByJyo_GUID]', @newname = N'DF_RaceResultByHorseByJyo_GUIDOnRaceResultByHorseByJyo_old', @objtype = N'OBJECT'
GO
...
CREATE TABLE [dbo].[RaceResultByHorseByJyo]
(
	...
	[JyoCD2] [char](2) COLLATE Japanese_CI_AS NOT NULL,
 ...
 CONSTRAINT [RaceResultByHorseByJyo_éÂÉLÅ[]  PRIMARY KEY NONCLUSTERED HASH 
(
	[RaceID],
	[KettoNum],
	[TrackTypeCD],
