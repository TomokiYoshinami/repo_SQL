...
EXEC dbo.sp_rename @objname = N'[dbo].[RaceResultByHorseByTrackCondition]', @newname = N'RaceResultByHorseByTrackCondition_old', @objtype = N'OBJECT'
GO

USE [Jackpot]
GO

EXEC [Jackpot].dbo.sp_rename @objname = N'[dbo].[DF_RaceResultByHorseByTrackCondition_GUID]', @newname = N'DF_RaceResultByHorseByTrackCondition_GUIDOnRaceResultByHorseByTrackCondition_old', @objtype = N'OBJECT'
GO
...
CREATE TABLE [dbo].[RaceResultByHorseByTrackCondition]
(
 ...
 CONSTRAINT [RaceResultByHorseByTrackCondition_éÂÉLÅ[]  PRIMARY KEY NONCLUSTERED HASH 
(
	[RaceID],
	[KettoNum],
	[TrackTypeCD],
...
ALTER TABLE [dbo].[RaceResultByHorseByTrackCondition] ADD  CONSTRAINT [DF_RaceResultByHorseByTrackCondition_GUID]  DEFAULT (newid()) FOR [GUID]
GO

INSERT INTO [Jackpot].[dbo].[RaceResultByHorseByTrackCondition] ([RecordSpec], [DataKubun], [MakeDate], [RaceDate], [JyoCD], [Kaiji], [Nichiji], [RaceNum], [RaceID], [KettoNum], [TrackTypeCD], [TrackConditionCD], [RunCount], [HitCount1], [HitRate1], [HitCount2], [HitRate2], [HitCount3], [HitRate3], [HitCount4], [HitRate4], [HitCount5], [HitRate5], [HitCount6], [HitRate6], [TS], [HitCount12], [HitRate12], [HitCount123], [HitRate123], [RunCountLog], [HitCount1Log], [HitRate1Log], [HitCount2Log], [HitRate2Log], [HitCount3Log], [HitRate3Log], [HitCount4Log], [HitRate4Log], [HitCount5Log], [HitRate5Log], [HitCount6Log], [HitRate6Log], [HitCount12Log], [HitRate12Log], [HitCount123Log], [HitRate123Log], [OddsWin], [OddsWinLog], [OddsPlace1], [OddsPlace1Log], [OddsPlace2], [OddsPlace2Log], [OddsWinInverse], [OddsPlaceInverse1], [OddsPlaceInverse2], [OddsWinInverseLog], [OddsPlaceInverse1Log], [OddsPlaceInverse2Log], [ApprovalRateWin], [ApprovalRateWinLog], [ApprovalRatePlace1], [ApprovalRatePlace1Log], [ApprovalRatePlace2], [ApprovalRatePlace2Log], [ExpectedValueWin], [ExpectedValueWinLog], [ExpectedValuePlace], [ExpectedValuePlaceLog], [StdTime], [StdTimeDev], [StdTimeDevMin], [StdTimeDevMax], [TS2], [GUID]) SELECT [RecordSpec], [DataKubun], [MakeDate], [RaceDate], [JyoCD], [Kaiji], [Nichiji], [RaceNum], [RaceID], [KettoNum], [TrackTypeCD], [TrackConditionCD], [RunCount], [HitCount1], [HitRate1], [HitCount2], [HitRate2], [HitCount3], [HitRate3], [HitCount4], [HitRate4], [HitCount5], [HitRate5], [HitCount6], [HitRate6], [TS], [HitCount12], [HitRate12], [HitCount123], [HitRate123], [RunCountLog], [HitCount1Log], [HitRate1Log], [HitCount2Log], [HitRate2Log], [HitCount3Log], [HitRate3Log], [HitCount4Log], [HitRate4Log], [HitCount5Log], [HitRate5Log], [HitCount6Log], [HitRate6Log], [HitCount12Log], [HitRate12Log], [HitCount123Log], [HitRate123Log], [OddsWin], [OddsWinLog], [OddsPlace1], [OddsPlace1Log], [OddsPlace2], [OddsPlace2Log], [OddsWinInverse], [OddsPlaceInverse1], [OddsPlaceInverse2], [OddsWinInverseLog], [OddsPlaceInverse1Log], [OddsPlaceInverse2Log], [ApprovalRateWin], [ApprovalRateWinLog], [ApprovalRatePlace1], [ApprovalRatePlace1Log], [ApprovalRatePlace2], [ApprovalRatePlace2Log], [ExpectedValueWin], [ExpectedValueWinLog], [ExpectedValuePlace], [ExpectedValuePlaceLog], [StdTime], [StdTimeDev], [StdTimeDevMin], [StdTimeDevMax], [TS2], [GUID] FROM [Jackpot].[dbo].[RaceResultByHorseByTrackCondition_old] 
