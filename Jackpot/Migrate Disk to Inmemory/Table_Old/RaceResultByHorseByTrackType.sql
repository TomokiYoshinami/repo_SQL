...
EXEC dbo.sp_rename @objname = N'[dbo].[RaceResultByHorseByTrackType]', @newname = N'RaceResultByHorseByTrackType_old', @objtype = N'OBJECT'
GO

USE [Jackpot]
GO

EXEC [Jackpot].dbo.sp_rename @objname = N'[dbo].[DF_RaceResultByHorseByTrackType_GUID]', @newname = N'DF_RaceResultByHorseByTrackType_GUIDOnRaceResultByHorseByTrackType_old', @objtype = N'OBJECT'
GO
...
CREATE TABLE [dbo].[RaceResultByHorseByTrackType]
(
 ...
 CONSTRAINT [RaceResultByHorseByTrackType_éÂÉLÅ[]  PRIMARY KEY NONCLUSTERED HASH 
(
	[RaceID],
	[KettoNum],
	[TrackTypeCD]
