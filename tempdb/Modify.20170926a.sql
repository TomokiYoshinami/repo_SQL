...
ALTER DATABASE tempdb MODIFY FILE(NAME = temp9, FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\tempdb_mssql_9.ndf', SIZE = 10 GB, MAXSIZE = 10 GB, FILEGROWTH = 1 GB);
GO